        ...
        <div className="w-full max-w-md">
          ...
          {success ? (
            <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl text-green-700 text-center animate-scale-in">
              ...
              <p className="text-sm mt-1">Please login with your admin credentials.</p>
              <button
          ...
          <div className="mt-6 text-center animate-slide-up stagger-6">
            ...
            <p className="text-slate-400 text-sm mt-3">
              <Link href="/register" className="text-green-500 hover:text-green-600 font-medium inline-flex items-center gap-1 transition-colors">
