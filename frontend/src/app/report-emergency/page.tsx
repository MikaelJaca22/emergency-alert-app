      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-red-900 via-orange-900 to-red-900 relative overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center px-8 animate-fade-in">
            <div className="w-20 h-20 bg-gradient-to-br from-red-500 to-orange-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-red-500/25 mb-6 mx-auto animate-float">
            ...
            <p className="text-lg text-red-100/70 max-w-md mx-auto animate-slide-up stagger-1">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="animate-slide-up stagger-4">
              ...
              <textarea
                ...
                required
                rows={4}
                className="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 resize-none transition-all duration-200"
              />
            </div>
